...
namespace netcore
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            {
                options.KnownProxies.Add(IPAddress.Parse("192.241.154.184"));
            });
            ...
            {
                c.SwaggerDoc("v1", new Info { Title = "FrBebidas API", Version = "v1" });
            });
        ...
        public void Configure(IApplicationBuilder app, IHostingEnvironment env)
        {
            ...
            app.UseSwaggerUI(c =>
            {
                c.SwaggerEndpoint("/swagger/v1/swagger.json", "Coral API");
            });
